	...
	<table border="1px" cellpadding="5px" cellspacing="0px" style="margin:0px auto;color:#fff">
		<thead>
			...
			<tr>
				...
				<td><center><a href="photo_update.php?id=<?php echo $data[0];?>&&action1=3"><i class="fa fa-pencil-square-o" style="font-size:20px;color:rebeccapurple;cursor:pointer"></i></a></center></td>
			</tr>
			<?php
				}
			?>
